...
// 	p := geometry.CreatePoint3d(2, 4)
// 	distance := p.DistanceTo(geometry.CreatePoint3d(0, 8))
// 	if distance != math.Sqrt(20) {
// 		t.Fatalf("%v != %v", distance, math.Sqrt(20))
// 	}
// }
...
// 	p := geometry.CreatePoint3d(2, 4)
// 	distance := p.DistanceTo(geometry.CreatePoint3d(0, 0))
// 	if distance != math.Sqrt(20) {
// 		t.Fatalf("%v != %v", distance, math.Sqrt(20))
// 	}
// }
...
// 	p := geometry.CreatePoint3d(2, 4)
// 	distance := p.DistanceTo(geometry.CreatePoint3d(4, 0))
// 	if distance != math.Sqrt(20) {
// 		t.Fatalf("%v != %v", distance, math.Sqrt(20))
// 	}
// }
